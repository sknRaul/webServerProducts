...
def update_product(id, product, description, stok, cost_price, sale_price):
	    db.update('products', where="id_product=$id", vars=locals(), product=product, description=description, stok=stok, cost_price=cost_price, sale_price=sale_price)

def add_product(product, description, stok, cost_price, sale_price):
    db.insert('products', product=product, description=description, stok=stok, cost_price=cost_price, sale_price=sale_price)
